...
public class GeoCoordDecoder extends AbstractDecoder {
	...
	public final RawLocationReference decodeData(final String id, final Object data)
		...
		if (!(data instanceof OpenlrGeoCoordinate)) {
			throw new OpenLRDatex2Exception(XMLErrorType.DATA_ERROR,
					"incorrect data class");
		}
		OpenlrGeoCoordinate gCoord = (OpenlrGeoCoordinate) data;
		GeoCoordinates geoCoord = createGeoCoord(gCoord.getOpenlrCoordinate());
