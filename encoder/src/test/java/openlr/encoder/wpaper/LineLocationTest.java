 ...
 */
public class LineLocationTest extends AbstractEncoderTest {

    /** Delivers the positive offset expected after encoding.*/
    private static final int EXPECTED_POSITIVE_OFFSET = 150;
    ...
    final Location getInputLocation() {
        if (inputLocation == null) {
            inputLocation = td.getWhitepaperLineLocation();
        }
    ...
    final Lrps[] getExpectedLrps() {
        return new Lrps[]{Lrps.LRP1, Lrps.LRP2, Lrps.LRP3};
    }
    ...
    final int[] getExpectedOffsets() {
        return new int[]{EXPECTED_POSITIVE_OFFSET, 0};
    }
