 ...
 * @author DLR e.V. (RE)
 */
public class DecodedCircleLocation extends openlr.location.CircleLocation {
     ...
     */
    public DecodedCircleLocation(final String idValue, final AffectedLines affected, final GeoCoordinates c, final long r) throws InvalidMapDataException {
        super(idValue, c.getLongitudeDeg(), c.getLatitudeDeg(), r);
