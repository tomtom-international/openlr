 ...
 * @author DLR e.V. (RE)
 */
public class DecodedClosedLineLocation extends openlr.location.ClosedLineLocation {
     ...
     * @param loc the location (boundary) lines
     */
    public DecodedClosedLineLocation(final String idValue, final AffectedLines affected, final List<Line> loc) {
        super(idValue, loc);
