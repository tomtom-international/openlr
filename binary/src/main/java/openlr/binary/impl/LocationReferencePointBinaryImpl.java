...
public class LocationReferencePointBinaryImpl implements LocationReferencePoint {
    ...
    public LocationReferencePointBinaryImpl(final int seqNr, final FunctionalRoadClass frcValue,
                                            final FormOfWay fowValue, final double longitudeValue,
                                            final double latitudeValue, final double bearingValue,
                                            final int dnp, final FunctionalRoadClass lfrcnpValue,
                                            final boolean last) {
